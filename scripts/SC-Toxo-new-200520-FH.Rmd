...
```{r, scale the calculated percentages}
...
write.table(deg_t.gondii_allo, file = "~/t.gondi_dc/res/supplementary_data/supplementary_data_8.csv", sep = "\t", quote = F, row.names = F)
##split bt clusters
#cluster Tg1
