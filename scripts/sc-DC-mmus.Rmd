...
```{r, visualize gene sets in heatmap}

gene_data <- data.frame(t(as.matrix(se.dc.mus@assays$RNA@data)),cluster= se.dc.mus$cell_class_type,check.names = F)
#average data over clusters 
average_data <- aggregate(.~cluster, gene_data, mean)
cluster_name <- average_data[,1]
average_data <- apply(average_data[,2:ncol(average_data)],2,as.numeric)
...
#change column-order to have the same for all the plots 
colorder <- c("ctrl_GM-DC", "PTG_Lys3h_GM-DC" , "PTG_3h_GM-DC", "PTG_12h_GM-DC", "LDM_Lys3h_GM-DC", "LDM_3h_GM-DC" , "LDM_12h_GM-DC", "LPS_GM-DC", "ctrl_GM-Mac", "PTG_Lys3h_GM-Mac" , "PTG_3h_GM-Mac", "PTG_12h_GM-Mac", "LDM_Lys3h_GM-Mac", "LDM_3h_GM-Mac" , "LDM_12h_GM-Mac", "LPS_GM-Mac")

phmat1 <- phmat1[,colorder]

#make annotation_col

annotation_col <- data.frame(CellType = factor(rep(c("GM-DC", "GM-Mac"), each = 8)))
...
ann_cols <- list(CellType = c("GM-DC" = "mediumorchid4", "GM-Mac" = "turquoise4"), Strain = c("PTG" = "darkorange3", "LDM" = "blue3", "Control" = "forestgreen", "LPS" = "red3"), Time = c("gray20", "gray87"))
...
hmat_mousetoxo(data = mat,
               meta = se.dc.mus$cell_class_type, 
               seed = Pam_unique,
               cond = 1:8,
               ann = 1)
...
PAM_heatmap <- pheatmap(phmat1[Pam_unique,1:3], fontsize_row = 8, cellwidth = 15, clustering_distance_rows = "correlation", color = colorRampPalette(c("#440154" ,"#21908C", "#FDE725"))(200),
           annotation_col = annotation_col, annotation_colors = ann_cols, 
           name = "value", column_split = annotation_col$CellType, 
           angle_col = "45")


LPS_heatmap <- pheatmap(phmat1[LPS_unique,],fontsize_row = 8, cellwidth = 15, clustering_distance_rows = "correlation", color = colorRampPalette(c("#440154" ,"#21908C", "#FDE725"))(200),
           annotation_col = annotation_col, annotation_colors = ann_cols, 
           name = "value", column_split = annotation_col$CellType, 
           angle_col = "45")

#HMW_heatmap <- pheatmap(phmat1[HMW_unique,], fontsize_row = 4, cellwidth = 15, clustering_distance_rows = "correlation", cluster_cols = F, color = colorRampPalette(c("#440154" ,"#21908C", "#FDE725"))(200), angle_col = "45")
#no unique genes for HMW

Sev_heatmap <- pheatmap(phmat1[Sev_unique,],fontsize_row = 8, cellwidth = 15, clustering_distance_rows = "correlation", color = colorRampPalette(c("#440154" ,"#21908C", "#FDE725"))(200),
           annotation_col = annotation_col, annotation_colors = ann_cols, 
           name = "value", column_split = annotation_col$CellType, 
           angle_col = "45")

cGAMP_heatmap <- pheatmap(phmat1[cGAMP_unique,], fontsize_row = 8, cellwidth = 15, clustering_distance_rows = "correlation", color = colorRampPalette(c("#440154" ,"#21908C", "#FDE725"))(200),
           annotation_col = annotation_col, annotation_colors = ann_cols, 
           name = "value", column_split = annotation_col$CellType, 
           angle_col = "45")

cpGB_heatmap <- pheatmap(phmat1[cpGB_unique,], fontsize_row = 8, cellwidth = 15, clustering_distance_rows = "correlation", color = colorRampPalette(c("#440154" ,"#21908C", "#FDE725"))(200),
           annotation_col = annotation_col, annotation_colors = ann_cols, 
           name = "value", column_split = annotation_col$CellType, 
           angle_col = "45")

zymosan_heatmap <- pheatmap(phmat1[zymosan_unique,], fontsize_row = 8, cellwidth = 15, clustering_distance_rows = "correlation", color = colorRampPalette(c("#440154" ,"#21908C", "#FDE725"))(200),
           annotation_col = annotation_col, annotation_colors = ann_cols, 
           name = "value", column_split = annotation_col$CellType, 
           angle_col = "45")


png("~/t.gondi_dc/res/GEO_comparison/cpGB_score_heatmap_unique.png", width = 30, height = 40, units = "cm", res = 600)
cpGB_heatmap
dev.off()

png("~/t.gondi_dc/res/GEO_comparison/LPS_score_heatmap_all.png", width = 50, height = 0, units = "cm", res = 600)
LPS_heatmap
dev.off()
...
pheatmap(phmat1[c(dc_genes, dc_lps, mac_lps, mac_genes),c(1:8)], fontsize_row = 4, cellwidth = 15, clustering_distance_rows = "correlation", color = colorRampPalette(c("#440154" ,"#21908C", "#FDE725"))(200),
           annotation_col = annotation_col, annotation_colors = ann_cols, 
           name = "value", column_split = annotation_col$CellType, 
           angle_col = "45")

dc.phmat <- pheatmap(phmat1[dc_genes,], fontsize_row = 4, cellwidth = 15, clustering_distance_rows = "correlation", color = colorRampPalette(c("#440154" ,"#21908C", "#FDE725"))(200),
           annotation_col = annotation_col, annotation_colors = ann_cols, 
           name = "value", column_split = annotation_col$CellType, 
           angle_col = "45")

mac.phmat <- pheatmap(phmat1[mac_genes,], fontsize_row = 4, cellwidth = 15, clustering_distance_rows = "correlation", color = colorRampPalette(c("#440154" ,"#21908C", "#FDE725"))(200),
           annotation_col = annotation_col, annotation_colors = ann_cols, 
           name = "value", column_split = annotation_col$CellType, 
           angle_col = "45")


top.mac <- DoHeatmap(se.dc.mus, features = mac_genes, group.colors = c("GM-DC" = "mediumorchid4", "GM-Mac" = "turquoise4"), group.by = "celltype") + 
          theme(legend.position = "none")
top.mac
top.dc <- DoHeatmap(se.dc.mus, features = dc_genes, group.colors = c("GM-DC" = "mediumorchid4", "GM-Mac" = "turquoise4"), group.by = "celltype")
top.dc

png(filename = "~/t.gondi_dc/res/figures/comparison_phmat_averg_mac.png", width = 30, height = 25, units = "cm", res = 300)
print(mac.phmat)
dev.off()

```

```{r, visualize gene sets in heatmap for seperate cell types}

gene_data_1 <- data.frame(t(as.matrix(se.dc@assays$RNA@data)),cluster= se.dc$cell_class,check.names = F)
#average data over clusters 
average_data <- aggregate(.~cluster, gene_data_1, mean)
cluster_name <- average_data[,1]
average_data <- apply(average_data[,2:ncol(average_data)],2,as.numeric)
rownames(average_data) <- cluster_name
average_data <- t(average_data)
...
dc_PAM_heatmap  <- pheatmap(phmat1[gene.set_PAM,], fontsize_row = 4, cellwidth = 15, clustering_distance_rows = "correlation", cluster_cols = F, color = colorRampPalette(c("#440154" ,"#21908C", "#FDE725"))(200))

gene.set_LPS_dc <- subset(gene.set_LPS, gene.set_LPS %in% rownames(se.dc))
dc_LPS_heatmap <- pheatmap(phmat1[gene.set_LPS_dc,], fontsize_row = 4, cellwidth = 15, clustering_distance_rows = "correlation", cluster_cols = F, color = colorRampPalette(c("#440154" ,"#21908C", "#FDE725"))(200))

#export
png("~/t.gondi_dc/res/GEO_comparison/PAM_score_heatmap_dc.png", width = 50, height = 40, units = "cm", res = 600)
dc_PAM_heatmap 
dev.off()

png("~/t.gondi_dc/res/GEO_comparison/LPS_score_heatmap_dc.png", width = 50, height = 40, units = "cm", res = 600)
dc_LPS_heatmap
dev.off()

##Run for MACs

gene_data_2 <- data.frame(t(as.matrix(se.mac@assays$RNA@data)),cluster= se.mac$cell_class,check.names = F)
#average data over clusters 
average_data <- aggregate(.~cluster, gene_data_2, mean)
cluster_name <- average_data[,1] 
average_data <- apply(average_data[,2:ncol(average_data)],2,as.numeric)
rownames(average_data) <- cluster_name
average_data <- t(average_data)
...
PAM_heatmap_mac <- pheatmap(phmat2[gene.set_PAM,], fontsize_row = 4, cellwidth = 15, clustering_distance_rows = "correlation", cluster_cols = F, color = colorRampPalette(c("#440154" ,"#21908C", "#FDE725"))(200))
gene.set_LPS_mac <- subset(gene.set_LPS, gene.set_LPS %in% rownames(se.mac))
LPS_heatmap_mac <- pheatmap(phmat2[gene.set_LPS_mac,], fontsize_row = 4, cellwidth = 15, clustering_distance_rows = "correlation", cluster_cols = F, color = colorRampPalette(c("#440154" ,"#21908C", "#FDE725"))(200))

#export
png("~/t.gondi_dc/res/GEO_comparison/PAM_score_heatmap_mac.png", width = 50, height = 40, units = "cm", res = 600)
print(PAM_heatmap_mac)
dev.off()

png("~/t.gondi_dc/res/GEO_comparison/LPS_score_heatmap_mac.png", width = 50, height = 40, units = "cm", res = 600)
LPS_heatmap_mac
dev.off()
...
LDM_12h_markers <- subset(LDM_12h_markers$gene, LDM_12h_markers$avg_log2FC > 1 &LDM_12h_markers$p_val_adj < 0.05)
LDM_3h_markers <- subset(cellclass.markers, cellclass.markers$cluster == "LDM_3h")
LDM_3h_markers <- subset(LDM_3h_markers$gene, LDM_3h_markers$avg_log2FC > 0.5 &LDM_3h_markers$p_val_adj < 0.05)
...
PTG_12h_markers <- subset(PTG_12h_markers$gene, PTG_12h_markers$avg_log2FC > 1 & PTG_12h_markers$p_val_adj < 0.05)
PTG_3h_markers <- subset(cellclass.markers, cellclass.markers$cluster == "PTG_3h")
PTG_3h_markers <- subset(PTG_3h_markers$gene, PTG_3h_markers$avg_log2FC > 1 & PTG_3h_markers$p_val_adj < 0.05)
...
prr_unique <- list(LPS_unique, Pam_unique, cpGB_unique, HMW_unique, cGAMP_unique, Sev_unique, zymosan_unique)

PTG_12h_int <- set_names(sapply(prr_unique, function(x){
  intersect(PTG_12h_markers, x)
}), nm = c("LPS", "prr", "cpGB", "HMW", "cGAMP", "SeV", "Zymosan"))
...
```
Write a function to look at gene expressions of different gene sets of interest in a heatmap. 

In the function you should define: 
1. gene-set of interest
2. 
