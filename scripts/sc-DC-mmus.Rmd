...
cowplot::plot_grid(cycp1, cycp2, cycp3, cycp4, cycp5, cycp6, cols = 6)
...
markers_4 <- FindMarkers(se.dc.mus, ident.1 = 4, ident.2 = 3, logfc.threshold = 2)
...
gse4_BP <- gseGO(geneList=gene_list, 
             ont ="BP", 
             nPerm = 1000,
             keyType = "SYMBOL",
             minGSSize = 3, 
...
ridgeplot(gse4, showCategory = 30,  core_enrichment = T) + 
...
p <- heatplot(gse4_BP, showCategory = 20, foldChange = gene_list) +
  ggplot2::scale_fill_gradientn(colors = colorRampPalette(c("#440154" ,"#21908C", "#FDE725"))(200))
...
pheatmap(phmat1[rownames(dc.12h.markers.3),c(4,5)], fontsize_row = 8, cellheight = 8, cellwidth = 40, clustering_distance_rows = "correlation", cluster_cols = F, color = colorRampPalette(c("#440154" ,"#21908C", "#FDE725"))(200))
dev.off()
