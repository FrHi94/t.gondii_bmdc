...
#saveRDS(se.dc.mus, "~/Dropbox/shared_ankarklev/Franzi-analysis/seurat-objects/seurat-dc-200609")

#se.dc.mus <- readRDS( "~/Dropbox/shared_ankarklev/Franzi-analysis/seurat-objects/seurat-dc-200609")
...
umap.dc.m.clusters <- DimPlot(se.dc.mus, reduction = "umap", group.by = "seurat_clusters", cols = cUmapcluster)
...
#Make Umaps to display with and and without LPS and without LPS/Lysates 

se.dc.mus <- SetIdent(se.dc.mus, value = "cell_class")
#without LPS
noLPS <- WhichCells(se.dc.mus, idents = c("LDM_Lys3h", "PTG_12h", "LDM_12h", "PTG_Lys3h", "LDM_3h", "PTG_3h", "ctrl"))
pnoLPS.c <- DimPlot(object = se.dc.mus , cells = noLPS, reduction = "umap", group.by = "seurat_clusters")
pnoLPS.i <- DimPlot(object = se.dc.mus , cells = noLPS, reduction = "umap", group.by = "cell_class")
pnoLPS.c
pnoLPS.i

noLysLPS <-  WhichCells(se.dc.mus, idents = c("PTG_12h", "LDM_12h", "LDM_3h", "PTG_3h", "ctrl"))
pnolysLPS.c <- DimPlot(object = se.dc.mus , cells = noLysLPS , reduction = "umap", group.by = "seurat_clusters")
pnolysLPS.i <- DimPlot(object = se.dc.mus , cells = noLysLPS , reduction = "umap", group.by = "cell_class")
pnolysLPS.c
pnolysLPS.i
...
LPS_in_0 <- length(which(se.dc.mus@meta.data$cell_class == "LPS" & se.dc.mus@meta.data$seurat_clusters == 0))
LPS_in_1 <- length(which(se.dc.mus@meta.data$cell_class == "LPS" & se.dc.mus@meta.data$seurat_clusters == 1))
LPS_in_2 <- length(which(se.dc.mus@meta.data$cell_class == "LPS" & se.dc.mus@meta.data$seurat_clusters == 2))
LPS_in_3 <- length(which(se.dc.mus@meta.data$cell_class == "LPS" & se.dc.mus@meta.data$seurat_clusters == 3))
LPS_in_4 <- length(which(se.dc.mus@meta.data$cell_class == "LPS" & se.dc.mus@meta.data$seurat_clusters == 4))
LPS_in_5 <- length(which(se.dc.mus@meta.data$cell_class == "LPS" & se.dc.mus@meta.data$seurat_clusters == 5))
LPS_in_6 <- length(which(se.dc.mus@meta.data$cell_class == "LPS" & se.dc.mus@meta.data$seurat_clusters == 6))
LPS_in_7 <- length(which(se.dc.mus@meta.data$cell_class == "LPS" & se.dc.mus@meta.data$seurat_clusters == 7))
LPS_in_8 <- length(which(se.dc.mus@meta.data$cell_class == "LPS" & se.dc.mus@meta.data$seurat_clusters == 8))

LPS_perCluster <- c(LPS_in_0,LPS_in_1,LPS_in_2,LPS_in_3, LPS_in_4, LPS_in_5, LPS_in_6, LPS_in_7, LPS_in_8)
