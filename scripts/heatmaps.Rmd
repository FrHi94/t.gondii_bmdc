...
mat_12h <- pheatmap(phmat5[rownames(DEG_12h_im),], fontsize_row = 8, cellwidth = 15, clustering_distance_rows = "euclidean", cluster_cols = F, color = colorRampPalette(c("#440154" ,"#21908C", "#FDE725"))(1000))
